<x-app-layout>
    <div class="w-10/12 p-4 mx-auto bg-white rouded">
        ...
        @if ($is_my_recipe)
            <a href="{{ route('recipe.edit', ['id' => $recipe['id']]) }}" class="block w-2/12 p-4 my-4 mx-auto bg-white
             rounded text-center text-green-500 border border-green-500 hover:bg-green-500 hover:text-white">編集する</a>
        @endif
        ...
        <div class="w-10/12 p-4 mx-auto bg-white rouded">
            ...
            @foreach ($recipe['reviews'] as $review)
                <div class="backgroud-color rounded mb-4 p-4">
                    <div class="flex mb-4">
                    ...
                    <p class="text-gray-600 font-bold">{{ $recipe['user']['name'] }}</p>
                </div>
            @endforeach
        </div>
    </div>

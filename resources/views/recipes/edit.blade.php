<x-app-layout>
    ...
    <form action="{{ route('recipe.update', ['id' => $recipe['id']]) }}" method="POST"
     class="w-10/12 p-4 mx-auto bg-white rouded" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-2 rouded border border-gray-500 my-4">
            <div class="col-span-1">
                <img id="preview" class="object-cover w-full aspect-video" src="{{ $recipe['image'] }}" alt="recipe-image">
                <input type="file" id="image" name="image" class="border border-gray-300 p-2 mb-4 w-full rouded">
            </div>
            <div class="col-span-1 p-4">
                <input type="text" name="title" value="{{ $recipe['title'] }}" placeholder="レシピ名" class="border
                ...
                <h4c class="text-bold text-xl mb-4">材料を入力</h4>
                <div id="ingredients">
        ...
        <div class="flex justify-center">
            <button type="submit" class="bg-green-500 hover:bg-green-700
             text-white font-bold py-2 px-4 rounded">レシピを更新する</button>
        </div>
